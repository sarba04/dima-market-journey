...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "DIMA Market — Une supérette. Une expérience." },
      { name: "description", content: "DIMA Market — visite immersive d'une supérette moderne à Casablanca. Alimentation, boulangerie, produits importés, boissons et snacks, servis avec exigence." },
      { property: "og:description", content: "DIMA Market — visite immersive d'une supérette moderne à Casablanca. Alimentation, boulangerie, produits importés, boissons et snacks, servis avec exigence." },
      { name: "twitter:description", content: "DIMA Market — visite immersive d'une supérette moderne à Casablanca. Alimentation, boulangerie, produits importés, boissons et snacks, servis avec exigence." },
